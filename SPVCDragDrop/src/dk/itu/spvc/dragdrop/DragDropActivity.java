...
public class DragDropActivity extends Activity {
	...
	public void setDragged(final FileAwareImageView imageView) {
		if (dragged == null) {
			// # create the PlayAreaView dragged object. Initially, move it to
			// 100,100
			dragged = new PlayAreaView(this, imageView.getDrawingCache(), 100,
					100);
			//
			try {
				if (client == null) {
				...
				client.sendImage(imageView.getImageInputStream(),
						new OnResult<Boolean>() {
							...
							public void onResult(Boolean res) {
								...
								if (res) {
									// # add the "dragged" PlayAreaView to the
									// frame
									Log.d("KONRAD", "dragging");
